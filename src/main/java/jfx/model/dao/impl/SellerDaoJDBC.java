...
public class SellerDaoJDBC implements SellerDao {
	...
	public List<Seller> findAll() {
		...
		try {
			...
			while (rs.next()) {
				//Se o departamento ja existir nessa lista, ele não é instanciado de novo evitando repetição e a criação de mais de uma instancia do mesmo departamento
